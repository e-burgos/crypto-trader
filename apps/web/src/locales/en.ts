const en = {
  ...
  trading: {
    ...
    orderExecutionSub: 'Configure the price at which buy orders are generated relative to market price',
  ...
  config: {
    ...
    guide: {
      ...
      preset: {
        ...
        conservativeDesc: 'Low risk, high thresholds, small positions. Ideal for first-time users.',
        balanced: 'Balanced',
        balancedDesc: 'Recommended starting point. Good risk/reward balance.',
        aggressive: 'Aggressive',
        aggressiveDesc: 'Higher risk, lower thresholds, larger positions. For experienced users only.',
      },
      cardThresholds: 'Decision Thresholds',
      cardThresholdsDesc: 'Controls the minimum confidence score the LLM must return for the agent to act.',
      cardThresholdsTip: 'Higher values = fewer, more confident trades. Start at 70%+.',
      cardRisk: 'Stop Loss / Take Profit',
      cardRiskDesc: 'Automatic exit rules that protect your capital on every open position.',
      ...
      cardCapitalDesc: 'Max % of your balance the agent can use in a single order.',
      ...
      cardTimingDesc: 'How often the agent checks the market and how many positions it can hold.',
      timingExample1: 'minInterval: 60 min',
      timingExample2: '→ Agent evaluates market at most once per hour',
      cardTimingTip: 'Longer intervals = less noise. 60–120 min is a good default.',
    },
  },
