const en = {
  ...
  admin: {
    ...
    // Agent table columns
    agentColPair: 'Pair',
    agentColName: 'Config Name',
    agentColUser: 'User',
    agentColMode: 'Mode',
    agentColStatus: 'Status',
    agentColUpdated: 'Last Update',
    noActiveAgents: 'No agents running at this time',
    agentPageInfo: 'Showing {{from}}-{{to}} of {{total}} agents',
    docPending: 'Pending',
  ...
  analytics: {
    ...
    agentCost: {
      title: 'LLM Cost by Bot',
      subtitle: 'Real AI model spend, by bot and by calendar day (UTC)',
      totalCost: 'Total Cost',
      llmDecisions: 'LLM Decisions',
      llmDecisionsSub: 'Resolved by calling a model',
      gateDecisions: 'Gate Decisions',
      gateDecisionsSub: 'HOLD without signal, $0 cost',
      totalDecisions: 'Total Decisions',
      unpricedNote:
        '{{count}} decisions with no available rate, not included in cost',
      dailyChartTitle: 'Daily cost by bot',
      tableBot: 'Bot',
      tableMode: 'Mode',
      tableCost: 'Cost',
      ...
      noDataDescription: 'No agent decisions in the selected period.',
      error: 'Could not load LLM cost. Try again later.',
    },
  },
  settings: {
    title: 'Settings',
  ...
  positions: {
    ...
    entries: {
      linkLabel: 'Resting entries',
      highlighted: 'Entry from the notification',
      unknownBot: 'This bot is no longer in your list',
      columns: {
        bot: 'Bot',
        type: 'Type',
        level: 'Level',
      ...
      level: {
        stopPair: 'Breakout {{stop}} → {{stopLimit}}',
        trailing: 'Breakout trails the price ({{bips}} bips)',
      },
      notionalHint: 'Capital committed on the exchange, calculated when the entry was placed',
      outcome: {
        expiresAt: 'Expires on {{when}}',
        cancelledAt: 'Cancelled on {{when}}',
        expiredAt: 'Expired on {{when}}',
        missing: 'The backend cannot confirm it on the exchange',
      },
      fill: {
        legLimit: 'Filled on the support leg',
        legStop: 'Filled on the breakout leg',
        price: 'at ${{price}}',
        quantity: '{{qty}} units',
      ...
      loadingMore: 'Loading…',
      empty: {
        title: 'No resting entries',
        hint: 'Your bots have not left any entry on the exchange yet.',
        filteredHint: 'No entry matches the filters you picked.',
      },
      error: {
        title: "We couldn't load your entries",
        retry: 'Retry',
      },
      agentDetail: {
        title: 'Current entry on the exchange',
        none: 'No active entry',
        level: 'Level',
        notional: 'Notional',
        expiresAt: 'Expires',
        viewAll: "View all this bot's entries",
      },
    },
  },
  tooltips: {
  ...
  botAnalysis: {
    ...
    inputGroupMacro: 'Macro Context',
    inputSourcesNone: 'No sources active',
    inputMacroRegime: 'Market Regime',
    inputMacroNone: 'No macro data',
    ...
    inputAgentRunning: '{{count}} running',
    ...
    signalTechnical: 'Signal',
    confidenceLabel: 'Confidence',
    altfinsConfluence: 'External Signals (altfins)',
