              ...
              return (
                <li key={link.id}>
                  ...
                  >
                    ...
                    <span className={link.indent ? 'text-xs' : 'text-sm'}>
                      {link.label}
                    </span>
                    {isActive && !link.indent && (
  ...
  const groups: SidebarGroup[] = [
    ...
    },
    {
      ...
      links: [
        ...
        { id: 'binance', label: 'Binance', indent: true },
        { id: 'claude', label: 'Claude (Anthropic)', indent: true },
        { id: 'openai', label: 'OpenAI', indent: true },
        { id: 'groq', label: 'Groq', indent: true },
      ],
    },
  ];
