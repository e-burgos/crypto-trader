  ...
  async createConfig(userId: string, dto: CreateTradingConfigDto) {
    ...
    return this.prisma.tradingConfig.create({
      data: {
        ...
        lossCutEnabled: dto.lossCutEnabled ?? undefined,
        lossCutConfidenceThreshold: dto.lossCutConfidenceThreshold ?? undefined,
        lossCutMinLossPct: dto.lossCutMinLossPct ?? undefined,
        lossCutMinEdgeRatio: dto.lossCutMinEdgeRatio ?? undefined,
        smartSizingEnabled: dto.smartSizingEnabled ?? undefined,
        reduceSizeFactor: dto.reduceSizeFactor ?? undefined,
        nativeProtectionEnabled: dto.nativeProtectionEnabled ?? undefined,
        closeOnProtectionFailure: dto.closeOnProtectionFailure ?? undefined,
        stopLimitOffsetPct: dto.stopLimitOffsetPct ?? undefined,
        trailingStopEnabled: dto.trailingStopEnabled ?? undefined,
        trailingStopPct: dto.trailingStopPct ?? undefined,
        trailingActivationPct: dto.trailingActivationPct ?? undefined,
        partialTpEnabled: dto.partialTpEnabled ?? undefined,
        partialTpTriggerPct: dto.partialTpTriggerPct ?? undefined,
        partialTpSellPct: dto.partialTpSellPct ?? undefined,
        moveStopToBreakevenAfterPartial:
          dto.moveStopToBreakevenAfterPartial ?? undefined,
        maxPositionHoldMinutes: dto.maxPositionHoldMinutes ?? null,
        deterministicGateEnabled: dto.deterministicGateEnabled ?? undefined,
        gatePriceChangePct: dto.gatePriceChangePct ?? undefined,
        reactiveLoopEnabled: dto.reactiveLoopEnabled ?? undefined,
        maxActionsPerHour: dto.maxActionsPerHour ?? undefined,
        minActionIntervalSec: dto.minActionIntervalSec ?? undefined,
      },
    });
  }
